...
import com.example.bluetooth_project.BuildConfig;
...
public class BluetoothUtil {
     ...
     */
    private static void showRationaleDialog(Activity fragment, DialogInterface.OnClickListener listener) {
    ...
    private static void showSettingsDialog(Activity fragment) {
    ...
    public static boolean hasPermissions(Activity fragment, ActivityResultLauncher<String> requestPermissionLauncher) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.S)
            return true;
        boolean missingPermissions = fragment.checkSelfPermission(Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED;
    ...
    public static void onPermissionsResult(Activity fragment, boolean granted, PermissionGrantedCallback cb) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.S)
            return;
        boolean showRationale = fragment.shouldShowRequestPermissionRationale(Manifest.permission.BLUETOOTH_CONNECT);
        if (granted) {
